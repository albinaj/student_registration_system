...
{  
    ...
    $dob            = $_POST['dob'];
    $obj->stud_update($fac_id,$f_name,$dpt_name,$email,$mobile,$address,$dob);
}
?> 
            ...
            <div class="table-responsive m-b-40">
              <table class="table table-borderless table-data3">
                ...
                <?php 
                    ...
                    {
                            $var2 = $row['department'];
                            $sql = "SELECT * from student where department='".$var2."'";
                            $result = mysqli_query($conn,$sql);
                    ...
                    <tr>
                        ...
                        <td><a href="../views/fac_stud_profile.php?id1=<?php echo $row1['reg_no'];?> " class="btn btn-outline-secondary  btn-arrow-right" role="button">View Profile</a></td>
                    </tr> 
                    <?php 
                                }   
                            }
