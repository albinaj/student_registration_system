...
<?php 
                    ...
                    $var = $_GET['id'];
                    $sql = "SELECT * from department WHERE semester='".$var."'";
                    $result = mysqli_query($conn,$sql);
                    if($row = mysqli_fetch_assoc($result))
                    {
						           ?>
                <h4> Department/<?php echo $_SESSION['fac_dept'];?> </h4>
                ...
                <tbody>
                  <?php 
                    ...
                    <tr>
                        ...
                        <td><a href="../views/faculty_edit_semester.php?id=<?php echo $row['semester']; ?>" class="btn btn-outline-secondary  btn-arrow-right" role="button">Edit/Update</a></td>
                    </tr> 
