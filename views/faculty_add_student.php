...
<?php   
    ...
    if(isset($_POST['submit']))
    {
        ...
        $gender         = $_POST['gender'];
        $pass           = $_POST['password'];
        $obj->stud_reg($s_name,$dpt_name,$email,$mobile,$address,$dob,$gender,$pass);
    }
?> 
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="faculty_view_student.php">View Students</a>
                                </li>
                        ...
                        <div class="login-form">
                            <form  method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="s_name" placeholder="Student Name">
                                </div>
                                <div class="form-group">
                                    ...
                                    <?php
                                                                    ...
                                                                    if($row = mysqli_fetch_assoc($result))
                                                                        ...
                                                                        ?>
                                    <input class="au-input au-input--full" type="text" name="dpt_name" value="<?php echo  $row['department'];?>" readonly>
                                </div>
                                <?php
                                                                        }?>
                                <div class="form-group">
