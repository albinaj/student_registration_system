...
<div class="row m-t-30">
     ...
     <div class="col-md-12">
        <!-- DATA TABLE-->
              ...
              <table class="table table-borderless table-data3">
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td><a href="..views/faculty_add_timetable.php?id=<?php $sem; ?>" class="btn btn-outline-secondary  btn-arrow-right" role="button">Edit</a></td>
                    </tr> 
                    <?php 
					            }
                      ?> 
            ...
            <a class="btn btn-primary" href="faculty_add_timetable.php?id=<?php $row['department'];?>">Add timetable</a>   
</div>
