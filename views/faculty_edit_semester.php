...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
           ...
           <?php include '../controller/MyController.php';
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sub3          = $_POST['sub3'];
        $sub4          = $_POST['sub4'];
        $obj->faculty_edit_sub($sub1,$sub2,$sub3,$sub4,$semester);
    }
?> 
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            ...
                            <?php
                                ...
                                $var=$_GET['id'];
                                $var2 =$_SESSION['fac_dept'];
                                $sql="SELECT * from department where semester='".$var."' and department='".$var2."'";
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="semester" placeholder="Semester" value="<?php echo $row['semester'];?>">
                                </div> 	
                                <div class="form-group">
                                    <label>Subject 1</label>
                                    <input class="au-input au-input--full" type="text" name="sub1" placeholder="Subject 1" value="<?php echo $row['sub1'];?>">
                                </div>
                                <div class="form-group">
                                    <label>subject 2</label>
                                    <input class="au-input au-input--full" type="text" name="sub2" placeholder="Subject 2" value="<?php echo $row['sub2'];?>">
                                </div>
                                <div class="form-group">
                                    <label>Subject 3</label>
                                    <input class="au-input au-input--full" type="text" name="sub3" placeholder="Subject 3" value="<?php echo $row['sub3'];?>">
                                </div>
                                <div class="form-group">
                                    <label>Subject 4</label>
                                    <input class="au-input au-input--full" type="text" name="sub4" placeholder="Subject 4" value="<?php echo $row['sub4'];?>">
                                </div>
                                <?php
                                    }
                                    ?>
