                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="admin_department.php">Computer Science</a>
                                </li>
                                
                                <li>
                                    <a href="admin_department.php">Commerce</a>
                                </li>
                                <li>
                                    <a href="admin_department.php">History</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="admin_semesters.php">View Students</a>
                                </li>
                                ...
                                <li>
                                    <a href="admin_semesters.php">Remove Student</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="admin_semesters.php">Computer Science</a>
                                </li>
                                
                                <li>
                                    <a href="admin_semesters.php">Commerce</a>
                                </li>
                                <li>
                                    <a href="admin_semesters.php">History</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
