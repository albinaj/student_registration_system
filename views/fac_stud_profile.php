                ...
                <div class="login-wrap">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <br>
                            <br>
                            <a href="faculty_edit_stud_profile.php?id=<?php echo $row['reg_no'];?>"><button class="btn btn-primary">Edit Profile</button></a>
                            </div>
                        </div>
                        <div class="login-form">
                            <form  method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="s_name" placeholder="Faculty Name" value="<?php echo $row['s_name'];?>" readonly>
                                </div>
                                <div class="form-group">
